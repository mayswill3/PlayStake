  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 p-4 lg:p-6">
      ...
      <div className="rounded-xl border border-surface-800 bg-surface-900 p-6 space-y-4">
        <div className="h-6 w-32 animate-pulse rounded-lg bg-surface-800" />
        <div className="h-4 w-full animate-pulse rounded-lg bg-surface-800" />
        <div className="h-4 w-full animate-pulse rounded-lg bg-surface-800" />
        <div className="h-4 w-3/4 animate-pulse rounded-lg bg-surface-800" />
      </div>
    </div>
  );
}
