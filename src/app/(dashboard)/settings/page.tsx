  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="mt-6 pt-6 border-t border-surface-800">
          <div className="flex items-center justify-between">
            ...
            {profile?.twoFactorEnabled ? (
              ...
              <Button variant="secondary" size="sm" onClick={handleEnable2FA}>
                Enable 2FA
              </Button>
            )}
          </div>
      ...
      <Card>
        ...
        <div className="mt-4 p-4 rounded-lg bg-surface-800 text-center">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 p-4 rounded-lg bg-surface-800">
