...
import { Zap, X, LogOut, ChevronUp, Wallet } from 'lucide-react';
    ...
    <div className="lg:hidden">
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 z-[200] flex h-14 w-14 items-center justify-center rounded-full bg-brand-600 text-white shadow-lg shadow-brand-600/30 active:scale-95 transition-transform"
