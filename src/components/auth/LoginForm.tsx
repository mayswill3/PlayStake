...
export function LoginForm() {
  ...
  return (
    <div className="rounded-[calc(1.15rem-1px)] bg-card p-6 shadow-ps-shadow-lg sm:p-8">
      <h1 className="mb-1 text-2xl font-display font-bold text-fg">
        Welcome back
      </h1>
      <p className="mb-6 text-sm text-fg-secondary">
        Sign in to your PlayStake account
      </p>
      ...
      {error && (
        <div
          className="mb-4 rounded-lg border border-danger-500/25 bg-danger-500/10 p-3 text-sm text-danger-500"
          role="alert"
        >
          {error}
        </div>
      ...
      <a
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-themed bg-elevated px-4 py-2.5 text-sm font-medium text-fg transition-colors hover:bg-page"
      >
